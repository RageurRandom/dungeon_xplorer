...
• Si vous choisissez le sentier couvert de ronces, rendez-vous au chapitre 4.', NULL);
...
• Si vous décidez d''ignorer les bruits et de poursuivre votre route, rendez-vous au chapitre 6.', NULL);
...
• Après avoir vaincu le sanglier, vous pourrez vous rendre au chapitre 8 sinon rendez-vous au chapitre 10.', NULL);
...
• Si vous ignorez cette curiosité et poursuivez votre route, allez au chapitre 9.', NULL);
...
Rendez-vous sans perdre de temps au chapitre 10.', NULL);
